...
const { approveClubRequest, approveMemberRequest, rejectMemberRequest, deleteMember, createEvent, listUsers, promoteUser, deleteUser, listClubMemberships, listEventRegistrations } = require('../controllers/adminController');
...
router.delete('/member/:id', authMiddleware, isAdmin, deleteMember);
